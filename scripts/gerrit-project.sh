...
GERRIT_HOST="Subinsmani@gerrit.pixysos.com"
...
GERRIT_PROJECT_NAMES="$(grep 'pixys' ~/pixys/.repo/manifests/snippets/pixys.xml | awk '{print $3}' | awk -F'"' '{print $2}' | uniq)"
